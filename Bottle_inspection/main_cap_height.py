...
def detect_cracks(image_path, rect_x, rect_y, rect_width, rect_height):
    ...
    for contour in contours:
        ...
        print("Koordinat titik teratas (y):", y)
        cX = int(M["m10"] / M["m00"])
        cY = int(M["m01"] / M["m00"])
        # print(f"cX: {cX}, cY: {cY}")
        cv2.line(contour_image, (cX-160, y), (cX+150, y), (255, 0, 255), 1)    
    
    # cv2.rectangle(contour_image, (cX-120, cY-180), (cX+110, cY-130), (0, 255, 255), 1)
    # contrast_value = 10
    # threshold_bp = 70
...
if __name__ == "__main__":
    image_file = "sample_botol/botol_sudut.bmp"
    rect_x = 346
    rect_y = 1
    rect_width = 1
    rect_height = 1
